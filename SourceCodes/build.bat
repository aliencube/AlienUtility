...
::BUILD
"tools\nuget.exe" restore AlienUtility.sln
"%MSBUILDDIR%msbuild.exe" "03_Services\AppUtilities\AppUtilities.csproj" /t:ReBuild /p:Configuration=Release;TargetFrameworkVersion=v4.5;DefineConstants="TRACE;NET45";OutPutPath=bin\Release\net45\;DocumentationFile=bin\Release\net45\Aliencube.AppUtilities.xml
...
::PACK
"tools\nuget.exe" pack "03_Services\AppUtilities\AppUtilities.nuspec" -OutputDirectory build
